...
- **변호사 · 자문단** (법무법인경국 3rd / Figma `sub-01-03`):
  ...
  - **Portrait upload names:** lawyers `{parkhyoyoung,gongdaeho-card,gongseongjun,sinjiho}.jpg` under `public/assets/lawyers/`; advisors `{leeseokwoo,yoonkyuhee,junghyun,joara,baekjinki}.jpg` under `public/assets/advisors/` — then `python3 scripts/generate-progressive-images.py`.
