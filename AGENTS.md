...
- **경국인 · 갤러리** (법무법인경국 4th / Figma `sub-01-04`, `94:3369`):
  ...
  - 경국인 section: brand **pyramid** (고객/경국인/경국, `public/assets/gallery/pyramid.*`, labels baked into the image) + serif **quote** (`--font-serif` NanumMyeongjo, teal `icon-quote.svg`) + **경국인의 약속** (10 rows: teal `#58bdc2` `w-34` number badge + English 32px + Korean desc; same label-left/content-right 2-col as 정비/공익).
