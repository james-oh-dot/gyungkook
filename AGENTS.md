...
- Hero responsive source: Figma `AI-hero-change` → `HOME_DESKTOP2` / `HOME_TABLET2` / `HOME_MOBILE2`
  ...
  - Statue (slide 01) ≤1024: Figma-wide box (tablet **611×1023** aspect, mobile **~107vw × 700/418**), `object-fit: cover` + `object-position: center bottom` so **scales/sword are not L/R cropped**. Do not reuse desktop tall/narrow `145vh` cover box on tablet/mobile.
