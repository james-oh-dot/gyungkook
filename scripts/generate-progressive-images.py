...
TARGETS: list[tuple[str, int]] = [
    ...
    # 변호사 · 자문단 directory card portraits
    ("lawyers/parkhyoyoung.jpg", 600),
    ("lawyers/gongdaeho-card.jpg", 600),
    ("lawyers/gongseongjun.jpg", 600),
    ("lawyers/sinjiho.jpg", 600),
    ("advisors/leeseokwoo.jpg", 600),
    ("advisors/yoonkyuhee.jpg", 600),
    ("advisors/junghyun.jpg", 600),
    ("advisors/joara.jpg", 600),
    ("advisors/baekjinki.jpg", 600),
