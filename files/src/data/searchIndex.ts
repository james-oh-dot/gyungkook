...
const ROUTE_DOCS: SearchDoc[] = [
  ...
  doc('practice-renewal', '정비사업 · 실적', '/practice/renewal', [REDEV, '정비사업 · 실적'],
  ...
  doc('practice-public', '공익사업 · 실적', '/practice/public', [REDEV, '공익사업 · 실적'],
    PUBLIC_TABS, PUBLIC_OVERVIEW, PUBLIC_RECORD_1, PUBLIC_COMPENSATION, PUBLIC_PROCEDURE, PUBLIC_RECORD_2),
  doc('other-cases', '분야별 사례', '/other/cases', [OTHER, '분야별 사례'], CASE_STUDIES),
